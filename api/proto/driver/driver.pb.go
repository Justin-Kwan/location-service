...
type CheckHealthResponse struct {
	...
	ServiceStatus int32 `protobuf:"varint,1,opt,name=serviceStatus,proto3" json:"serviceStatus,omitempty"`
}
...
func (x *CheckHealthResponse) GetServiceStatus() int32 {
	if x != nil {
...
var file_driver_proto_rawDesc = []byte{
	,
...
var file_driver_proto_goTypes = []interface{}{
	(*CheckHealthRequest)(nil),  // 0: CheckHealthRequest
	(*CheckHealthResponse)(nil), // 1: CheckHealthResponse
}
var file_driver_proto_depIdxs = []int32{
	0, // 0: LocationService.CheckHealth:input_type -> CheckHealthRequest
	1, // 1: LocationService.CheckHealth:output_type -> CheckHealthResponse
...
func (c *locationServiceClient) CheckHealth(ctx context.Context, in *CheckHealthRequest, opts ...grpc.CallOption) (*CheckHealthResponse, error) {
	out := new(CheckHealthResponse)
	err := c.cc.Invoke(ctx, "/LocationService/CheckHealth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedLocationServiceServer) CheckHealth(context.Context, *CheckHealthRequest) (*CheckHealthResponse, error) {
...
func _LocationService_CheckHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckHealthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocationServiceServer).CheckHealth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/LocationService/CheckHealth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).CheckHealth(ctx, req.(*CheckHealthRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _LocationService_CheckHealth_Handler,
		},
	},
